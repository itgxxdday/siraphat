...
# --- Core Analysis Function (UPDATED: High Sensitivity with /10 Factor) ---
def analyze_droplets_core(img, paper_width, paper_height):
    """
    ฟังก์ชันหลักสำหรับการวิเคราะห์ภาพหยดละออง 
    (ใช้ Adaptive Thresholding และปรับค่าความหนาแน่นให้หาร 10)
    """
